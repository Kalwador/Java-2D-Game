...
public class Skill_przed {
    ...
    public Skill_przed(int id_skill, String nazwa, String opis, int dmg, int poison, int target, int icon, double cooldown, double stun) {
    ...
    public void warriorSkills() {
        ArrayList<Skill_przed> warrior = new ArrayList<Skill_przed>();
        warrior.add(new Skill_przed(1, "Cios", "Przemodelowanie facjaty", 15, 0, 3, 1, 5.0, 0));
    }

    public void mageSkills() {
        ArrayList<Skill_przed> mage = new ArrayList<Skill_przed>();
        mage.add(new Skill_przed(1, "FireBall", "Kula ognia", 30, 0, 3, 2, 3.0, 0));
        mage.add(new Skill_przed(2, "Fire breath", "Ognisty oddech spopielajacy wrogow w poblizu", 40, 1, 4, 3, 10.0, 0)); //zatruty, aoe
