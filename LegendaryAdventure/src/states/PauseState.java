...
public class PauseState extends BasicGameState {
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
        ...
        if (actualSubWindow == 0) {
            ...
            Fonts.print18().drawString(591, 384, "Powrót do menu", ctab[2]);
            Fonts.print18().drawString(591, 449, "Wyjdź z gry", ctab[3]);
        }
        ...
        if (actualSubWindow == 1) {
            ...
            if (core.GameStatus.musicOn) {
                Fonts.print18().drawString(591, 384, "Muzyka OFF", ctab[2]);
            } else {
                Fonts.print18().drawString(591, 384, "Muzyka ON", ctab[2]);
            }            
            Fonts.print18().drawString(591, 449, "Powrót", ctab[3]);
        }
