...
public class CharacterState extends BasicGameState {
    ...
    private static int copyOfActualXPtoSpend = 9;
    private static int copyOfStrength = 44;
    private static int copyOfAgility = 17;
    private static int copyOfDefence = 34;
    private static int copyOfWisdom = 10;
    //-----------------------------------------
...
//        g.drawImage(nowy Obrazek(sciezka obrazka), 868, 372);  
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int i) throws SlickException {
        ...
        if (actualXPtoSpend >= 0 && actualXPtoSpend < copyOfActualXPtoSpend) {
            if ((xpos > 617 && xpos < 635) && (ypos > 428 && ypos < 451)) {
                if (input.isMousePressed(0) && strength > copyOfStrength) {
                    //siła -
                    strength--;
                    actualXPtoSpend++;
                }
            ...
            if ((xpos > 617 && xpos < 635) && (ypos > 392 && ypos < 413)) {
                if (input.isMousePressed(0) && agility > copyOfAgility) {
                    //zręczność -
                    agility--;
                    actualXPtoSpend++;
                }
            ...
            if ((xpos > 617 && xpos < 635) && (ypos > 350 && ypos < 370)) {
                if (input.isMousePressed(0) && defence > copyOfDefence) {
                    //obrona -
                    defence--;
                    actualXPtoSpend++;
                }
            ...
            if ((xpos > 617 && xpos < 635) && (ypos > 310 && ypos < 331)) {
                if (input.isMousePressed(0) && wisdom > copyOfWisdom) {
                    //mądrość -
                    wisdom--;
                    actualXPtoSpend++;
                }
        ...
        if (actualXPtoSpend > 0) {
            if ((xpos > 652 && xpos < 674) && (ypos > 428 && ypos < 451)) {
            ...
            if ((xpos > 652 && xpos < 674) && (ypos > 392 && ypos < 413)) {
                if (input.isMousePressed(0)) {
                    //zręczność +
                    agility++;
                    actualXPtoSpend--;
            ...
            if ((xpos > 652 && xpos < 674) && (ypos > 350 && ypos < 370)) {
                if (input.isMousePressed(0)) {
                    //obrona +
                    defence++;
                    actualXPtoSpend--;
            ...
            if ((xpos > 652 && xpos < 674) && (ypos > 310 && ypos < 331)) {
                if (input.isMousePressed(0)) {
                    //mądrość +
                    wisdom++;
                    actualXPtoSpend--;
        ...
        //Przycisk Zapisz
        if ((xpos > 622 && xpos < 664) && (ypos > 204 && ypos < 293)) {
            if (input.isMousePressed(0)) {
                copyOfActualXPtoSpend = actualXPtoSpend;
                copyOfStrength = strength;
                copyOfAgility = agility;
                copyOfDefence = defence;
                copyOfWisdom = wisdom;
