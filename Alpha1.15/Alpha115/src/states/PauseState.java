...
public class PauseState extends BasicGameState {
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
        ...
        Fonts.printf().drawString(607, 142, "PAUZA");
        ...
        Fonts.printf().drawString(521, 184, "Gra", c[0]);
        Fonts.printf().drawString(711, 184, "Opcje", c[1]);
        ...
        if (actualSubWindow == 0) {
            Fonts.printf().drawString(591, 257, "Zapisz grę", ctab[0]);
            Fonts.printf().drawString(591, 319, "Wczytaj grę", ctab[1]);
            Fonts.printf().drawString(591, 384, " --- ", ctab[2]);
            Fonts.printf().drawString(591, 449, "Powrót do menu", ctab[3]);
        }
        // wyświetlanie dla zakładki opcje
        if (actualSubWindow == 1) {
            Fonts.printf().drawString(591, 257, "Opcja 1", ctab[0]);
            Fonts.printf().drawString(591, 319, "Opcja 2", ctab[1]);
            Fonts.printf().drawString(591, 384, "Opcja 3", ctab[2]);
            Fonts.printf().drawString(591, 449, "Opcja 4", ctab[3]);
        }
