...
public class Skills {
    ...
    public Skills(int id_skill, String nazwa, String opis, int dmg, int poison, int target, int icon, double cooldown, double stun) {
    ...
    public void warriorSkills() {
        ArrayList<Skills> warrior = new ArrayList<Skills>();
        warrior.add(new Skills(1, "Cios", "Przemodelowanie facjaty", 15, 0, 3, 1, 5.0, 0));

    }

    public void mageSkills() {
        ArrayList<Skills> mage = new ArrayList<Skills>();
        mage.add(new Skills(1, "FireBall", "Kula ognia", 30, 0, 3, 2, 3.0, 0));
        mage.add(new Skills(2, "Fire breath", "Ognisty oddech spopielajacy wrogow w poblizu", 40, 1, 4, 3, 10.0, 0)); //zatruty, aoe
